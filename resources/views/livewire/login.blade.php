...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div>
            <h1 class="mt-6 text-center text-3xl font-extrabold text-blue-600">
                SAFE
            </h1>
        ...
        <form class="mt-8 space-y-6" wire:submit.prevent="submit">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                <div>
                    ...
                    @error('email') <span class="bg-red-100 block w-full border-red-500 text-red-700 p-4" role="alert">{{ $message }}</span> @enderror
                </div>
                <div>
                    ...
                    @error('password') <span class="bg-red-100 block w-full border-red-500 text-red-700 p-4" role="alert">{{ $message }}</span> @enderror
                </div>
            </div>
