<div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
    <div class="bg-gray-800 pt-3">
        <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
            <h3 class="font-bold pl-2">Add new staff member</h3>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input 
                        class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                        wire:model="form.password" id="phone" type="password" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <div class="relative">
                        <select wire:model="form.role_id" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
...
<?php /**PATH /home/vagrant/space/nursing-app/resources/views/livewire/create-staff.blade.php ENDPATH**/ ?>